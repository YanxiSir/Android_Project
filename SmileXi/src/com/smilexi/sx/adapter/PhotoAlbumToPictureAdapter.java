...
import com.smilexi.sx.util.BitmapCache;
import com.smilexi.sx.util.BitmapCache.ImageCallback;
import com.smilexi.sx.util.L;

public class PhotoAlbumToPictureAdapter extends BaseAdapter {
	...
	public PhotoAlbumToPictureAdapter(Activity act, List<ImageItem> list,
			Handler mHandler) {
		this.act = act;
		dataList = list;
