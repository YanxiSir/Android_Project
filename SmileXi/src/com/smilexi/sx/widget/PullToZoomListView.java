...
public class PullToZoomListView extends ListView implements
		...
		if (scrollState == OnScrollListener.SCROLL_STATE_IDLE) {
			if (view.getLastVisiblePosition() == view.getCount() - 1
				...
				if (mOnLoadMoreListener != null) {
					OnLoadingMore();
					mOnLoadMoreListener.onLoadMore(PullToZoomListView.this);
	...
	public boolean onTouchEvent(MotionEvent paramMotionEvent) {
		...
		case MotionEvent.ACTION_UP:
			...
			if(mLastMotionY - mInitialMotionY > mDistance && !isLoadMore && !isRefreshing){
				if(mOnRefreshListener != null ){
					OnRefreshing();
					mOnRefreshListener.onRefresh(PullToZoomListView.this);
				}
	...
	public static interface OnRefreshListener<V extends View> {
		...
		public void onRefresh(PullToZoomListView refreshView);

	}

	public static interface OnLoadMoreListener<V extends View> {

		public void onLoadMore(PullToZoomListView refreshView);
